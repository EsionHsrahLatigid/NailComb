...
namespace
{
class NailCombStandaloneApplication final : public juce::JUCEApplication
{
public:
    NailCombStandaloneApplication()
    {
...
START_JUCE_APPLICATION(NailCombStandaloneApplication)
