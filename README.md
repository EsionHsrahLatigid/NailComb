...
- `nailcomb_editor_tests`: custom editor, all parameter controls, tooltips, accessibility names, and minimal monochrome header-only paint with no decoration below y=80.
